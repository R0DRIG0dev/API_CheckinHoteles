...
insert into usuarios values (null,'Manuel','123456','s');

insert into hoteles values 
(null,'Casona Plaza Hotel AQP','Calle San José 207 - Arequipa','front.aqp@casonaplazahoteles.com',51951302597);
insert into hoteles values 
(null,'Casona Plaza Hotel Colonial','Calle Álvarez Thomas 435 – Arequipa','front.colonial@casonaplazahoteles.com',51951302596);
insert into hoteles values 
(null,'Casona Plaza Hotel Ecolodge','Av. Collahua S/N – Yanque – Valle del Colca','front.colca@casonaplazahoteles.com',51951752410);
insert into hoteles values 
(null,'Casona Plaza Hotel Puno','Jirón Puno 280 – Puno','front.puno@casonaplazahoteles.com',51951751814);
insert into hoteles values 
(null,'Casona Plaza Hotel Centro','Jirón Lima 787 – Puno','front.centro@casonaplazahoteles.com',51940271369);
insert into hoteles values 
(null,'Hotel Balsa Inn','Jirón Cajamarca 555 - Puno','front.balsa@casonaplazahoteles.com',51951302591);

insert into idiomas values(null,'English');
insert into idiomas values(null,'French');
insert into idiomas values(null,'Spanish');
...
insert into checkins values(null,'2020-05-08','2020-05-12',default,1,null,'ABC123',1,3);
insert into checkins values(null,'2020-05-08','2020-06-12',default,1,null,'Aft153',1,3);
insert into checkins values(null,'2020-08-01','2020-09-01',default,1,1,'AWW773',1,3);

insert into documentos values(null,'DNI');
insert into documentos values(null,'Pasaporte');
insert into documentos values(null,'Carnet de extranjeria');
insert into documentos values(null,'Otros');

insert into huespedes values 
(null,1,'Manuel','Odria','a.manuelOdria@algo.algo','m',1,11111111,'Perú','a','1979-01-30','2017-01-30','2025-01-30',1);
insert into huespedes values 
(null,2,'Carlos','Mariategui','Mariategui@algo.algo','m',1,22222222,'Perú','a','1989-01-30','2020-01-30','2028-01-30',1);
insert into huespedes values 
(null,3,'Alan','Garcia','AlanRata@algo.algo','m',1,33333333,'Perú','a','1996-01-30','2015-01-30','2023-01-30',1);
insert into huespedes values 
(null,3,'Tommy','Garcia',null,'m',1,44444444,'Perú','n','2007-01-30','2015-01-30','2023-01-30',0);

insert into PivotAdministracion values (null,1,1);
insert into PivotAdministracion values (null,1,2);
insert into PivotAdministracion values (null,1,3);
insert into PivotAdministracion values (null,1,4);
insert into PivotAdministracion values (null,1,5);
insert into PivotAdministracion values (null,1,6);
